...
from robosuite.environments.manipulation.MeltButter import MeltButter
...
if __name__ == "__main__":
    ...
    parser.add_argument("--environment", type=str, default="pick_up_butter")
    parser.add_argument("--robots", nargs="+", type=str, default="PandaOmron", help="Which robot(s) to use in the env")
    parser.add_argument(
    ...
    writer = imageio.get_writer("recording6.mp4", fps=20)
    ...
    while True:
        ...
        while step_count < 500:
            ...
            obs, reward, terminated, info = env.step(env_action)
            # Save image file
            writer.append_data(obs["table1_image"])
            print("Saving frame #{}".format(step_count))
            step_count += 1
            env.render()
