...
class MoveCubeToTable2(ManipulationEnv):
    def __init__(
        self,
        robots,
    ...
    def _setup_observables(self):
        ...
        self.initial_cube_height = self.model.mujoco_arena.table_offsets[0][2] + 0.02
        return observables
...
class pick_up_cube(MoveCubeToTable2):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
          
class navigate_to_second_table(MoveCubeToTable2):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.cached_states = np.load("/home/tj/Documents/robosuite/robosuite/environments/manipulation/cached_states/MoveCubeToTable2/pick_up_cube.npy")
...
class place_cube_on_table(MoveCubeToTable2):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.cached_states = np.load("/home/tj/Documents/robosuite/robosuite/environments/manipulation/cached_states/MoveCubeToTable2/navigate_to_second_table.npy")
